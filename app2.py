                ...
                try:
                    ...
                    if use_ml_model and 'model' in locals():
                        ...
                        if cv <= 0.5:
                            ...
                            try:
                                es_model, es_mae, es_rmse, es_r2 = build_exponential_smoothing_model(product_data)
                                
                                # Generate forecast
                                forecast = es_model.forecast(steps=forecast_days)
                                forecast = np.maximum(forecast, 0)
                                
                                future_df['Predicted_Sales'] = forecast
                                
                                # Use Exponential Smoothing metrics
                                mae, rmse, r2 = es_mae, es_rmse, es_r2
